...
- **`runpod/worker-comfyui:<version>-wan22-remix`**: Includes diffusion models, text encoders, VAE, and Lightning LoRAs for [WAN 2.2 Remix](https://huggingface.co/FX-FeiHou/wan2.2-Remix) (image-to-video generation).
